 ...
 */
public class ConCredencialFragment extends Fragment  implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.view = inflater.inflate(R.layout.fragment_con_credencial_list, container, false);
        ...
        if (view instanceof RecyclerView) {
            ...
            recyclerView.setAdapter(new UsuarioRecyclerViewAdapter(this.usuarios));
        }
...
*/
                if (view instanceof RecyclerView) {
                    ...
                    recyclerView.setAdapter(
                            new UsuarioRecyclerViewAdapter(this.usuarios));
                }
            }else {
                Snackbar mensagem = Snackbar.make(view,
